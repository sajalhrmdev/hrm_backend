...
// ================= GET ALL =================
export const getAllGlobalRoles = async (_req, res) => {
    try {
...
// ================= GET ONE =================
export const getGlobalRoleById = async (req, res) => {
    try {
...
// ================= UPDATE =================
export const updateGlobalRole = async (req, res) => {
    try {
        const id = Number(req.params.id);
        const { name, description } = req.body;
...
// ================= DELETE =================
export const deleteGlobalRole = async (req, res) => {
    try {
        const id = Number(req.params.id);
