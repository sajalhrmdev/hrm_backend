...
// GET ALL COMPANIES
// ============================================
export const getAllCompaniesService = async (page = 1, limit = 10, search = "") => {
...
export const updateMyCompanyService = async (companyId, payload) => {
...
export const updateBrandingService = async (companyId, data) => {
