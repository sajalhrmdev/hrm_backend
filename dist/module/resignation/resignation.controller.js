...
import { submitResignation, getMyResignations, getCompanyResignations, approveResignation, rejectResignation, cancelResignation, markInactive, revertApproval, } from "./resignation.service.js";
// ======================================================
// SUBMIT RESIGNATION (Employee)
// ======================================================
export const submitResignationController = async (req, res) => {
    try {
...
// ======================================================
export const getMyResignationController = async (req, res) => {
    try {
        const employee = req.employee;
        if (!employee) {
            throw new Error("Employee not found");
...
// ======================================================
export const getCompanyResignationsController = async (req, res) => {
    try {
...
// APPROVE RESIGNATION
// ======================================================
export const approveResignationController = async (req, res) => {
    try {
        const companyId = req.companyId;
        const user = req.user;
        if (!companyId || !user) {
...
// REJECT RESIGNATION
// ======================================================
export const rejectResignationController = async (req, res) => {
    try {
        const companyId = req.companyId;
        const user = req.user;
        if (!companyId || !user) {
...
// ======================================================
export const cancelResignationController = async (req, res) => {
    try {
        const employee = req.employee;
        if (!employee) {
            throw new Error("Employee not found");
...
// ======================================================
export const markInactiveController = async (req, res) => {
    try {
        const companyId = req.companyId;
        if (!companyId) {
            throw new Error("Unauthorized");
...
// ======================================================
export const revertApprovalController = async (req, res) => {
    try {
        const companyId = req.companyId;
        if (!companyId) {
            throw new Error("Unauthorized");
