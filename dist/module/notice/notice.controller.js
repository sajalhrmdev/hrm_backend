import { createNotice, getNotices, getSingleNotice, updateNotice, deleteNotice, } from "./notice.service.js";
// ======================================================
// CREATE
// ======================================================
export const createNoticeController = async (req, res) => {
    try {
        ...
        const { title, description, noticeDate, expiryDate, priority, isPublished, attachmentUrl, } = req.body;
