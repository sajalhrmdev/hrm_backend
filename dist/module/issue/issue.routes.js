...
import { submitIssueController, getMyIssuesController, getCompanyIssuesController, updateIssueStatusController, cancelIssueController, } from "./issue.controller.js";
...
router.patch("/:id/status", requirePermission("issue.manage"), updateIssueStatusController);
