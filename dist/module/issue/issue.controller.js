...
import { submitIssue, getMyIssues, getCompanyIssues, updateIssueStatus, cancelIssue, } from "./issue.service.js";
// ======================================================
// SUBMIT ISSUE (Employee)
// ======================================================
export const submitIssueController = async (req, res) => {
    try {
        ...
        const isAuthorized = permissions.includes("*") || permissions.includes("issue.manage");
...
// ======================================================
export const getMyIssuesController = async (req, res) => {
    try {
        const employee = req.employee;
        if (!employee) {
            throw new Error("Employee not found");
...
// ======================================================
export const getCompanyIssuesController = async (req, res) => {
    try {
...
// ======================================================
export const cancelIssueController = async (req, res) => {
    try {
        const employee = req.employee;
        if (!employee) {
            throw new Error("Employee not found");
