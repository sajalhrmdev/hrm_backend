import { getGoals, getGoalById, createGoal, updateGoal, submitProgress, approveGoal, getEmployeeGoals, } from "./goal.service.js";
...
export const submitProgressHandler = async (req, res) => {
    try {
        const companyId = req.companyId;
        if (!companyId)
            throw new Error("Company not found");
...
export const approveGoalHandler = async (req, res) => {
    try {
        const companyId = req.companyId;
        if (!companyId)
            throw new Error("Company not found");
...
export const listEmployeeGoals = async (req, res) => {
    try {
        const companyId = req.companyId;
        if (!companyId)
            throw new Error("Company not found");
