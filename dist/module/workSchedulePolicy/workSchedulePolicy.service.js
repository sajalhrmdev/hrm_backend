...
// GET ALL
// ======================================================
export const getWorkSchedulePolicies = async (companyId) => {
    return prisma.workSchedulePolicy.findMany({
        where: {
            companyId,
        },
...
// GET SINGLE
// ======================================================
export const getSingleWorkSchedulePolicy = async (companyId, id) => {
    const data = await prisma.workSchedulePolicy.findFirst({
        where: {
            id,
            companyId,
...
// DELETE
// ======================================================
export const deleteWorkSchedulePolicy = async (companyId, id) => {
    const existing = await prisma.workSchedulePolicy.findFirst({
        where: {
            id,
            companyId,
