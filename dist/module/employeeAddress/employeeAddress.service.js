...
// UPSERT ADDRESS
// ============================================
export const upsertEmployeeAddressService = async (companyId, employeeId, data) => {
    // ========================================
    // CHECK EMPLOYEE
    // ========================================
...
// GET ADDRESS
// ============================================
export const getEmployeeAddressService = async (companyId, employeeId) => {
    // ========================================
    // CHECK EMPLOYEE
    // ========================================
    const employee = await prisma.employee.findFirst({
...
// DELETE ADDRESS
// ============================================
export const deleteEmployeeAddressService = async (companyId, employeeId) => {
    // ========================================
    // CHECK EMPLOYEE
    // ========================================
    const employee = await prisma.employee.findFirst({
