...
// ============================================
export const upsertEmployeePersonalInfoService = async (companyId, employeeId, data) => {
    // ========================================
    // CHECK EMPLOYEE
    // ========================================
...
// GET PERSONAL INFO
// ============================================
export const getEmployeePersonalInfoService = async (companyId, employeeId) => {
    // ========================================
    // CHECK EMPLOYEE
    // ========================================
    const employee = await prisma.employee.findFirst({
...
// ============================================
export const deleteEmployeePersonalInfoService = async (companyId, employeeId) => {
    // ========================================
    // CHECK EMPLOYEE
    // ========================================
    const employee = await prisma.employee.findFirst({
