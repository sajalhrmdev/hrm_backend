...
// BULK CREATE
// ============================================
export const bulkCreateEmployeesService = async (companyId, employees) => {
    const formattedData = await Promise.all(employees.map(async (emp, index) => {
        const code = emp.employeeCode || `EMP${String(index + 1).padStart(4, "0")}`;
        return {
            companyId,
            name: emp.name,
            email: emp.email,
...
// GET SINGLE EMPLOYEE
// ============================================
export const getEmployeeByIdService = async (companyId, id) => {
...
// UPDATE EMPLOYEE
// ============================================
export const updateEmployeeService = async (companyId, id, data) => {
...
// DELETE EMPLOYEE
// ============================================
export const deleteEmployeeService = async (companyId, id) => {
    const existing = await prisma.employee.findFirst({
        where: {
            id,
            companyId,
...
// assigned shift======================================
export const assignShiftService = async (companyId, employeeId, shiftId) => {
    const employee = await prisma.employee.findFirst({
        where: {
            id: employeeId,
            companyId,
