...
//   employeeRoutes,
// );
app.use("/api/v1/attendance", authMiddleware, companyAccessMiddleware, attendanceRoutes);
app.use("/api/v1/attendance", authMiddleware, companyAccessMiddleware, 
// employeeMiddleware,
attendanceRegularizationRoutes);
app.use("/api/v1/employee-face", authMiddleware, employeeFaceRoutes);
app.use("/api/v1/leave", authMiddleware, companyAccessMiddleware, 
// employeeMiddleware,
leaveRoutes);
app.use("/api/v1/leave", authMiddleware, companyAccessMiddleware, employeeMiddleware, leaveIncrementRoutes);
app.use("/api/v1/leave-increment", authMiddleware, companyAccessMiddleware, employeeMiddleware, leaveIncrementPolicyRoutes);
app.use("/api/v1/leave-increment-log", authMiddleware, companyAccessMiddleware, employeeMiddleware, leaveIncrementLog);
app.use("/api/v1/salary-component", authMiddleware, companyAccessMiddleware, salaryComponentRoutes);
...
app.use("/api/v1/employee-address", authMiddleware, companyAccessMiddleware, employeeAddressRoutes);
app.use("/uploads", express.static("uploads"));
app.use("/api/v1/employee-document", authMiddleware, companyAccessMiddleware, employeeDocumentRoutes);
app.use("/api/v1/employee-bank-detail", authMiddleware, companyAccessMiddleware, employeeBankDetailRoutes);
app.use("/api/v1/employee-emergency-contact", authMiddleware, companyAccessMiddleware, employeeEmergencyContactRoutes);
app.use("/api/v1/employee-experience", authMiddleware, companyAccessMiddleware, employeeExperianceRoutes);
app.use("/api/v1/department", authMiddleware, companyAccessMiddleware, departmentRoutes);
app.use("/api/v1/designation", authMiddleware, companyAccessMiddleware, designationRoutes);
...
app.use("/api/v1/notice", authMiddleware, companyAccessMiddleware, employeeMiddleware, noticeRoutes);
app.use("/api/v1/performance", authMiddleware, companyAccessMiddleware, performanceReviewRoutes);
app.use("/api/v1/rewards", authMiddleware, companyAccessMiddleware, rewardRoutes);
...
app.use("/api/v1/issue", authMiddleware, companyAccessMiddleware, issueRoutes);
