...
const validateConfig = async (
  ...
  if (calculationType === "PERCENTAGE") {
    ...
    if (baseType === "COMPONENTS") {
      ...
      if (!ids.length) {
        throw new Error(
          "Percentage component with COMPONENTS base requires at least one base component",
        );
      }
  ...
  return {
    ...
    baseComponentIds:
      calculationType === "PERCENTAGE" ? (baseComponentIds ?? []) : [],
    percentageValue:
      calculationType === "PERCENTAGE" ? percentageValue : null,
    capAmount,
    floorAmount,
    baseCapAmount:
      calculationType === "PERCENTAGE" ? baseCapAmount : null,
  };
};
...
export const deleteSalaryComponent =
  async (
    ...
    if (usedAsBase) {
      throw new Error(
        "Component is used as a base by another component"
      );
    }
