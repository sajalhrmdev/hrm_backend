...
export const getEmployeeForDocument = async (req: AuthRequest, res: Response) => {
  try {
...
export const getCompanyDataForDocument = async (req: AuthRequest, res: Response) => {
  try {
    const companyId = req.companyId;
    if (!companyId) throw new Error("Company not found");
...
export const sendDocumentEmail = async (req: AuthRequest, res: Response) => {
  try {
    const companyId = req.companyId;
    if (!companyId) throw new Error("Company not found");
