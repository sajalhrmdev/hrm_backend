...
// ======================================================
// CREATE SINGLE PAYROLL ADJUSTMENT
// ======================================================
...
// ======================================================
// BULK PAYROLL ADJUSTMENT
// ======================================================

type BulkPayrollAdjustmentInput = {
  companyId: number;
  ...
  applyTo?: "ALL" | "DEPARTMENT" | "EMPLOYEES";

  note?: string;
};

export const bulkPayrollAdjustment = async (
  input: BulkPayrollAdjustmentInput,
) => {
  const {
    companyId,
    payrollRunId,
