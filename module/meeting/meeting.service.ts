...
const normalizeAttendeeIds = (attendees: any): number[] => {
...
const validateMeetingData = async (companyId: number, data: any) => {
...
export const createMeetingService = async (companyId: number, data: any) => {
...
export const getMeetingsService = async (
  ...
  const where: Prisma.MeetingWhereInput = {
    ...
    ...(meetingType ? { meetingType: meetingType as any } : {}),
    ...(search
      ? {
          OR: [
...
export const getMeetingByIdService = async (companyId: number, id: number) => {
...
export const updateMeetingService = async (
  ...
  return await prisma.meeting.update({
    ...
    data: {
      ...
      organizerId:
        data.organizerId != null && data.organizerId !== ""
...
export const deleteMeetingService = async (companyId: number, id: number) => {
  const existing = await prisma.meeting.findFirst({
    where: {
      id,
      companyId,
