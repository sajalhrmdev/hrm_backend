...
import {
  submitResignationController,
  getMyResignationController,
  getCompanyResignationsController,
  approveResignationController,
  rejectResignationController,
  cancelResignationController,
  markInactiveController,
  revertApprovalController,
