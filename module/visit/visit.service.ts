...
const validateVisitData = async (companyId: number, data: any) => {
...
export const createVisitService = async (companyId: number, data: any) => {
...
export const getMyVisitsService = async (
  companyId: number,
  employeeId: number,
  page = 1,
  limit = 10,
...
export const updateMyVisitStatusService = async (
  companyId: number,
  employeeId: number,
  id: number,
  status: any,
...
export const getVisitByIdService = async (companyId: number, id: number) => {
  const visit = await prisma.visit.findFirst({
    where: {
      id,
      companyId,
...
export const deleteVisitService = async (companyId: number, id: number) => {
  const existing = await prisma.visit.findFirst({
    where: {
      id,
      companyId,
