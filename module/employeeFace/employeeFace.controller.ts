...
import {
  registerEmployeeFaceService,
  getEmployeeFaceService,
  deleteEmployeeFaceService,
  findEmployeeFace,
} from "./employeeFace.service.js";
...
export const getEmployeeFace = async (req: Request, res: Response) => {
  try {
    const employeeId = Number(req.params.employeeId);
...
export const deleteEmployeeFace = async (req: Request, res: Response) => {
  try {
    const employeeId = Number(req.params.employeeId);
