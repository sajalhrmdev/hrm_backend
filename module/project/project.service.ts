...
const normalizeMemberIds = (members: any): number[] => {
...
const validateProjectData = async (companyId: number, data: any) => {
...
export const createProjectService = async (companyId: number, data: any) => {
...
export const getProjectByIdService = async (companyId: number, id: number) => {
...
export const deleteProjectService = async (companyId: number, id: number) => {
  const existing = await prisma.project.findFirst({
    where: {
      id,
      companyId,
